...
$params = [TimeService::sqlNow(), $id, $userId];
...
$stmt = $pdo->prepare("UPDATE notifications SET read_at = COALESCE(read_at, ?) WHERE {$where}");
$stmt->execute($params);

mobile_json(['success' => true, 'message' => 'Notification marquée comme lue']);
